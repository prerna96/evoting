 ...
 <script type="text/javascript"> 
  function valid()
  {
   ...
   var fileToUpload=myform.fileToUpload;
		...
		var d=new Date();//full date,mon,yr
	
			var yr=d.getFullYear();//give current year
     ...
     sp16.style.visibility="hidden";
       ...
       var status="true";
           ...
           else if(mnmv.value=="")
           {
            ...
            {
			 sp7.innerHTML="Unable to give vote";
			 sp7.style.color="red";
			 sp7.style.visibility="visible";
			 status=false;
			}
...
<form name="userreg" action="registdata.php" onsubmit="return(valid())" method="post" enctype="multipart/form-data">
